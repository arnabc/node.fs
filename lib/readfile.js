...
var sys = require('sys'),
    fs  = require('./../external/fs-promise'),
    defer = require( './../external/promise' ).defer,
...
function readRemoteFile( url ) {
    ...
    var client = http.createClient( url.port || 80, url.host );
    var req = client.request('GET', url.pathname, { host: url.host } );
    req.end();
